...
object CurriesPAF extends App {
  ...
  val add5 = curriedAdder(5) _ // convert this expr to Int => Int
  ...
  val add7 = (x: Int) => simpleAddFunction(7, x) // simples
  ...
  // compiler does sweet eta-expansion for us, so we not use _ in println
