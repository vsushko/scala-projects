...
object ScalaRecap extends App {
  ...
  val incrementer1: Function1[Int, Int] = new (Int => Int) {
    override def apply(v1: Int): Int = x + 1
  }
  ...
  aFuture.onComplete {
    case scala.util.Success(meaningOfLife) => println(s"I've found $meaningOfLife")
    case scala.util.Failure(ex) => println(s"I have failed: $ex")
  }
