...
object Joins extends App {
  ...
  // outer joins
  // left outer = everything in the inner join + all the rows in the LEFT table, with nulls in where the data is mission
  ...
  // option 2 - drop thee dupe column
  ...
  val bestPaidEmployeesDF = employeesSalariesDF.orderBy("maxSalary").limit(10)
